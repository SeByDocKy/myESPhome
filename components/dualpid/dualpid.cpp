...
#endif  
#ifdef USE_SWITCH 
   if((this->output_charging_ > 0.0f) & (this->current_r48_->get_r48()==false)){
      this->current_r48_->set_r48(true);
   }
   else if ((this->output_discharging_ > 0.0f) & (this->current_r48_->get_r48()==true)){
      this->current_r48_->set_r48(false);
   } 
#endif  
