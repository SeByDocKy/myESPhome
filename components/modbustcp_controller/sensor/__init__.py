...
ModbusTCPSensor = modbustcp_controller_ns.class_(
    "ModbusTCPSensor", cg.Component, sensor.Sensor, SensorItem
)
...
async def to_code(config):
    ...
    await add_modbus_base_properties(var, config, ModbusTCPSensor)
