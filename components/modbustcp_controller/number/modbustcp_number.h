...
class ModbusTCPNumber : public number::Number, public Component, public SensorItem {
 public:
  ...
  using transform_func_t = optional<float> (*)(ModbusTCPNumber *, float, const std::vector<uint8_t> &);
  using write_transform_func_t = optional<float> (*)(ModbusTCPNumber *, float, std::vector<uint16_t> &);
