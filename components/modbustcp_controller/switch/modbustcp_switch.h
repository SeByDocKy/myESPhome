...
class ModbusTCPSwitch : public Component, public switch_::Switch, public SensorItem {
 public:
  ModbusTCPSwitch(ModbusRegisterType register_type, uint16_t start_address, uint8_t offset, uint32_t bitmask,
  ...
  using transform_func_t = optional<bool> (*)(ModbusTCPSwitch *, bool, const std::vector<uint8_t> &);
  using write_transform_func_t = optional<bool> (*)(ModbusTCPSwitch *, bool, std::vector<uint8_t> &);
