...
class ModbusTCPTextSensor : public Component, public text_sensor::TextSensor, public SensorItem {
 public:
  ModbusTCPTextSensor(ModbusRegisterType register_type, uint16_t start_address, uint8_t offset, uint8_t register_count,
  ...
  using transform_func_t = optional<std::string> (*)(ModbusTCPTextSensor *, std::string, const std::vector<uint8_t> &);
