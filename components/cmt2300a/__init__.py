   ...
   cv.Schema(
    {
       ...
       cv.Required(CONF_GPIO1_PIN): pins.gpio_pin_schema({pins.CONF_OUTPUT: False, pins.CONF_INPUT: True}),
       # cv.Optional(CONF_GPIO1_PIN): pins.gpio_input_pin_schema,
       cv.Required(CONF_GPIO2_PIN): pins.gpio_pin_schema({pins.CONF_OUTPUT: True, pins.CONF_INPUT: True}),  
       # cv.Optional(CONF_GPIO2_PIN): pins.gpio_pin_schema,
       cv.Required(CONF_GPIO3_PIN): pins.gpio_pin_schema({pins.CONF_OUTPUT: True, pins.CONF_INPUT: True}),
