...
ChargingSetpointNumber = bioffsr_ns.class_("ChargingSetpointNumber", number.Number, cg.Component)
AbsorbingSetpointNumber = bioffsr_ns.class_("AbsorbingSetpointNumber", number.Number, cg.Component)
FloatingSetpointNumber = bioffsr_ns.class_("FloatingSetpointNumber", number.Number, cg.Component)
StartingBatteryVoltageNumber = bioffsr_ns.class_("StartingBatteryVoltageNumber", number.Number, cg.Component)
ChargedBatteryVoltageNumber = bioffsr_ns.class_("ChargedBatteryVoltageNumber", number.Number, cg.Component)
DischargedBatteryVoltageNumber = bioffsr_ns.class_("DischargedBatteryVoltageNumber", number.Number, cg.Component)
KpNumber = bioffsr_ns.class_("KpNumber", number.Number, cg.Component)
KiNumber = bioffsr_ns.class_("KiNumber", number.Number, cg.Component)
KdNumber = bioffsr_ns.class_("KdNumber", number.Number, cg.Component)
OutputMinNumber = bioffsr_ns.class_("OutputMinNumber", number.Number, cg.Component)
OutputMaxNumber = bioffsr_ns.class_("OutputMaxNumber", number.Number, cg.Component)
OutputRestartNumber = bioffsr_ns.class_("OutputRestartNumber", number.Number, cg.Component)
...
async def to_code(config):
  ...
  if charging_setpoint_config := config.get(CONF_CHARGING_SETPOINT):
        ...
        await cg.register_parented(n, bioffsr_component)
        cg.add(bioffsr_component.set_charging_setpoint_number(n))
  ...
  if absorbing_setpoint_config := config.get(CONF_ABSORBING_SETPOINT):
        ...
        await cg.register_parented(n, bioffsr_component)
        cg.add(bioffsr_component.set_absorbing_setpoint_number(n))
  ...
  if floating_setpoint_config := config.get(CONF_FLOATING_SETPOINT):
        ...
        await cg.register_parented(n, bioffsr_component)
        cg.add(bioffsr_component.set_floating_setpoint_number(n))     
  ...
  if starting_battery_voltage_config := config.get(CONF_STARTING_BATTERY_VOLTAGE):
        ...
        await cg.register_parented(n, bioffsr_component)
        cg.add(bioffsr_component.set_starting_battery_voltage_number(n))
  ...
  if charged_battery_voltage_config := config.get(CONF_CHARGED_BATTERY_VOLTAGE):
        ...
        await cg.register_parented(n, bioffsr_component)
        cg.add(bioffsr_component.set_charged_battery_voltage_number(n))
  ...
  if discharged_battery_voltage_config := config.get(CONF_DISCHARGED_BATTERY_VOLTAGE):
        ...
        await cg.register_parented(n, bioffsr_component)
        cg.add(bioffsr_component.set_discharged_battery_voltage_number(n))  
  ...
  if kp_config := config.get(CONF_KP):
        ...
        await cg.register_parented(n, bioffsr_component)
        cg.add(bioffsr_component.set_kp_number(n)) 
  ...
  if ki_config := config.get(CONF_KI):
        ...
        await cg.register_parented(n, bioffsr_component)
        cg.add(bioffsr_component.set_ki_number(n))
  ...
  if kd_config := config.get(CONF_KD):
        ...
        await cg.register_parented(n, bioffsr_component)
        cg.add(bioffsr_component.set_kd_number(n))
  ...
  if output_min_config := config.get(CONF_OUTPUT_MIN):
        ...
        await cg.register_parented(n, bioffsr_component)
        cg.add(bioffsr_component.set_output_min_number(n))
  ...
  if output_max_config := config.get(CONF_OUTPUT_MAX):
        ...
        await cg.register_parented(n, bioffsr_component)
        cg.add(bioffsr_component.set_output_max_number(n))
  ...
  if output_restart_config := config.get(CONF_OUTPUT_RESTART):
        ...
        await cg.register_parented(n, bioffsr_component)
        cg.add(bioffsr_component.set_output_restart_number(n))        