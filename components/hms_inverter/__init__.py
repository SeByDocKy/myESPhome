...
_ns = cg.esphome_ns.namespace("hms_inverter")
_cls = _ns.class_("HmsPlatform", cg.PollingComponent)
_inv_cls = _ns.class_("HmsInverter", cg.Component)
_chan_cls = _ns.class_("HmsChannel", cg.Component)

_num_cls = _ns.class_("HmsNumber", number.Number)
_but_cls = _ns.class_("HmsButton", button.Button, cg.Component)
