...
class HmsInverter : public esphome::Component {
    ...
    public:
        ...
        float get_palevel() {return this->current_palevel_ ;}
        void set_oldpalevel(float value) {this->former_palevel_ = value;}
        float get_oldpalevel() {return this->former_palevel_ ;}
