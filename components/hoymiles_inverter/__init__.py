...
async def to_code(config):
    ...
    cg.add_library("Frozen", None, "https://github.com/tbnobody/OpenDTU/lib/Frozen@main")
    cg.add_library("Every", None, "https://github.com/tbnobody/OpenDTU/lib/Every@main")
    cg.add_library("ThreadSafeQueue", None, "https://github.com/tbnobody/OpenDTU/lib/ThreadSafeQueue@main")
    cg.add_library("TimeoutHelper", None, "https://github.com/tbnobody/OpenDTU/lib/TimeoutHelper@main")
    cg.add_library("CMT2300a", None, "https://github.com/tbnobody/OpenDTU/lib/CMT2300a@main")
    cg.add_library("SPI", None)
    cg.add_library("Hoymiles", None, "https://github.com/tbnobody/OpenDTU/lib/Hoymiles@main")
