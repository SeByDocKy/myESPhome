...
async def to_code(config):
    ...
    cg.add_library("Frozen", None, "https://github.com/tbnobody/OpenDTU/tree/master/Frozen")
    cg.add_library("Every", None, "https://github.com/tbnobody/OpenDTU/tree/master/Every")
