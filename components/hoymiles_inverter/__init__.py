...
async def to_code(config):
    ...
    cg.add_library("SpiManager", None, "https://github.com/tbnobody/OpenDTU")
    cg.add_library("CMT2300A", None, "https://github.com/tbnobody/OpenDTU")
    cg.add_library("Hoymiles", None, "https://github.com/tbnobody/OpenDTU")
    cg.add_library("ThreadSafeQueue", None, "https://github.com/tbnobody/OpenDTU")
    cg.add_library("TimeoutHelper", None, "https://github.com/tbnobody/OpenDTU")
    cg.add_library("Frozen", None, "https://github.com/tbnobody/OpenDTU")
    cg.add_library("Every", None, "https://github.com/tbnobody/OpenDTU")
