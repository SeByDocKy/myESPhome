...
async def to_code(config):
    ...
    cg.add_library("Frozen", None, "https://github.com/tbnobody/OpenDTU/lib/Frozen@master")
    cg.add_library("Every", None, "https://github.com/tbnobody/OpenDTU/lib/Every@master")
    cg.add_library("ThreadSafeQueue", None, "https://github.com/tbnobody/OpenDTU/lib/ThreadSafeQueue@master")
    cg.add_library("TimeoutHelper", None, "https://github.com/tbnobody/OpenDTU/lib/TimeoutHelper@master")
    cg.add_library("CMT2300a", None, "https://github.com/tbnobody/OpenDTU/lib/CMT2300a@master")
    cg.add_library("SPI", None)
    cg.add_library("Hoymiles", None, "https://github.com/tbnobody/OpenDTU/lib/Hoymiles@master")
