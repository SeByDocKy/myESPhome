...
async def to_code(config):
    ...
    # cg.add_library("Frozen", None, "https://github.com/tbnobody/OpenDTU/tree/master/lib/Frozen")
    # cg.add_library("Every", None, "https://github.com/tbnobody/OpenDTU/tree/master/lib/Every")
    # cg.add_library("ThreadSafeQueue", None, "https://github.com/tbnobody/OpenDTU/tree/master/lib/ThreadSafeQueue")
    # cg.add_library("TimeoutHelper", None, "https://github.com/tbnobody/OpenDTU/tree/master/lib/TimeoutHelper")
    # cg.add_library("CMT2300a", None, "https://github.com/tbnobody/OpenDTU/tree/master/lib/CMT2300a")
    # cg.add_library("SPI", None)
    # cg.add_library("Hoymiles", None, "https://github.com/tbnobody/OpenDTU/tree/master/lib/Hoymiles")
