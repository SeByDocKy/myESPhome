...
class DUALPIDPCMBinarySensor : public Component, public Parented<DUALPIDPCMComponent> {
 public:
  ...
  void set_undervoltage_lockout_binary_sensor(binary_sensor::BinarySensor *bs) { this->undervoltage_lockout_binary_sensor_ = bs; }
  void set_timer_standby_binary_sensor(binary_sensor::BinarySensor *bs) { this->timer_standby_binary_sensor_ = bs; }
 ...
 protected:
  ...
  binary_sensor::BinarySensor *undervoltage_lockout_binary_sensor_{nullptr};
  binary_sensor::BinarySensor *timer_standby_binary_sensor_{nullptr};
