...
uint16_t VEML6075Component::calc_rawuva(void){
    ...
    this->read_register(VEML6075_REG_UVA , (uint8_t *) &data, (size_t)1 , true);	 // dummy reading to close connexion	
    return result;	    
}
...
uint16_t VEML6075Component::calc_rawuvb(void){
    ...
    this->read_register(VEML6075_REG_UVA , (uint8_t *) &data, (size_t)1 , true);	 // close connexion	
    return result;	    
}
