...
class HMS_REGULATIONSensor : public Component, public Parented<HMS_REGULATIONComponent> {
 public:
  void dump_config() override;
  void setup() override;
  void set_parent(HMS_REGULATIONComponent *parent) { this->parent_ = parent; }
 ...
 protected:
  ...
  HMS_REGULATIONComponent *parent_;
